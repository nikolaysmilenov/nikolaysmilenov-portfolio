...
export const bg: Dictionary = {
  ...
  about: {
    ...
    title: "За мен",
    paragraph1:
      "Аз съм разработчик, който създава модерни уеб приложения и дигитални продукти, с нарастващ интерес към AI и киберсигурността.",
    paragraph2:
      "Уча основно чрез практика — превръщам идеите в работещи уебсайтове, платформи и инструменти, докато непрекъснато разширявам техническите си знания.",
  },
  projects: {
    number: "02 / Проекти",
