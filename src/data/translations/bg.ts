...
export const bg: Dictionary = {
  ...
  services: {
    ...
    additionalWorkDescription:
      "Допълнителна работа извън включения месечен ресурс: €30 / час.",
  ...
  contact: {
    ...
    sending: "Изпращане...",
    submitSuccess:
      "Съобщението е изпратено успешно. Ще се свържа с Вас възможно най-скоро.",
    submitError:
      "Възникна проблем. Опитайте отново или ми пишете директно.",
